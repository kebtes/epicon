...
def load_iris(return_X_y=False):
    ...
    try:
        ...
        raise ImportError("pandas is required for loading Iris dataset. Install with: pip install pandas")
...
def _fallback_iris(return_X_y=False):
    ...
    return Bunch(data=data, target=target, target_names=target_names, feature_names=feature_names, DESCR="Iris plants dataset")
...
def load_mnist(return_X_y=False):
    ...
    try:
        ...
        raise ImportError("pandas is required for loading MNIST dataset.")
